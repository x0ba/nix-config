...
HI(
  ...
  { bold = true, cterm = { bold = true }, fg = "#EE5396" }
)
HI(
  0,
...
HI(
  ...
  { cterm = { underline = true }, sp = "#90EE90", underline = true }
)
...
HI(
  0,
  "@function",
  { bold = true, cterm = { bold = true }, fg = "#FF7EB6", link = "TSFunction" }
)
...
HI(
  0,
  "@symbol",
  { bold = true, cterm = { bold = true }, fg = "#82CFFF", link = "TSSymbol" }
)
...
HI(
  ...
  { bg = "#161616", bold = true, cterm = { bold = true }, fg = "#EE5396" }
)
HI(
  0,
  "StatusLineDiagnosticWarn",
  { bg = "#161616", bold = true, cterm = { bold = true }, fg = "#BE95FF" }
)
...
HI(
  ...
  { default = true, link = "TelescopePreviewNormal" }
)
HI(
  0,
  "TelescopePreviewMessageFillchar",
  { default = true, link = "TelescopePreviewMessage" }
)
...
HI(
  0,
  "markdownBoldItalic",
  { bold = true, cterm = { bold = true, italic = true }, italic = true }
)
...
HI(
  ...
  { bold = true, cterm = { bold = true }, fg = "#E39C45" }
)
...
HI(
  ...
  { cterm = { strikethrough = true }, sp = "#FF0000", strikethrough = true }
)
...
HI(
  0,
  "Underlined",
  { cterm = { underline = true }, fg = "#F07342", underline = true }
)
HI(0, "Type", { fg = "#959A6B" })
...
HI(
  ...
  { default = true, link = "TelescopeSelection" }
)
...
HI(
  ...
  { default = true, link = "SpecialComment" }
)
...
HI(
  0,
  "MatchParen",
  { bg = "#725A5A", cterm = { underline = true }, underline = true }
)
...
HI(
  ...
  { cterm = { undercurl = true }, fg = "#D0D0D0", undercurl = true }
)
...
HI(
  0,
  "CmpItemMenu",
  { cterm = { italic = true }, fg = "#9C8181", italic = true }
)
