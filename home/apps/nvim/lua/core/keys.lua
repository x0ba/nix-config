...
map('n', '<C-q>', ":lua require('harpoon.ui').nav_file(1)<CR>", { silent = true })
map('n', '<C-w>', ":lua require('harpoon.ui').nav_file(2)<CR>", { silent = true })
map('n', '<C-z>', ":lua require('harpoon.ui').nav_file(3)<CR>", { silent = true })
map('n', '<C-x>', ":lua require('harpoon.ui').nav_file(4)<CR>", { silent = true })
