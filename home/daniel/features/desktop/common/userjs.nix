''
  ...
  user_pref("privacy.sanitize.sanitizeOnShutd0wn", false); // Used to delete cookies and site data when Firefox is closed… set to `false` to enable cookie and site data persistence
