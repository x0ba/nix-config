...
local M = function(m)
  ...
  if m == "minimal" then
    ERROR = (errors and errors > 0) and ("%#StalineLspErrorIcon#" .. "X" .. "%#StalineLspError#" .. errors) or ""
    WARNING = (warnings and warnings > 0) and ("%#StalineLspWarningIcon#" .. "!" .. "%#StalineLspWarning#" .. warnings)
      or ""
    HINT = (hints and hints > 0) and ("%#StalineLspHintsIcon#" .. "@" .. "%#StalineLspHints#" .. hints) or ""
    INFO = (info and info > 0) and ("%#StalineLspInfoIcon#" .. "i" .. "%#StalineLspInfo#" .. info) or ""
  elseif m == "fancy" then
    ERROR = (errors and errors > 0) and ("%#StalineLspErrorIcon#" .. "X" .. "%#StalineLspError#" .. errors) or ""
    WARNING = (warnings and warnings > 0) and ("%#StalineLspWarningIcon#" .. "!" .. "%#StalineLspWarning#" .. warnings)
      or ""
