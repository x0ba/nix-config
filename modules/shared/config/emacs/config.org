...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/daniel/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/daniel/bin" "/profile/bin" "/Users/daniel/.npm-packages/bin" "/Users/daniel/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
